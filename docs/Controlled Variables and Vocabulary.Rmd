...
|  |  MSL |  A tidal datum, Mean Sea Level as measured against a local tide gauges |
|  |  MTL |  A tidal datum, Mean Tidal Level as measured against a local tide gauges |
|  |  MHW |  A tidal datum, Mean High Water as measured against a local tide gauges |
|  |  MHHW |  A tidal datum, Mean Higher High Water as measured against a local tide gauges |
|  |  MHHWS |  A tidal datum, Mean Higher High Water for Spring Tides as measured against a local tide gauges |
|  |  MLW |  A tidal datum, Mean Low Water as measured against a local tide gauges |
|  |  MLLW |  A tidal datum, Mean Lower Low Water as measured against a local tide gauges |
